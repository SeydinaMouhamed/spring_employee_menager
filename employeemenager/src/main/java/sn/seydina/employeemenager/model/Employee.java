package sn.seydina.employeemenager.model;
...
public class Employee implements Serializable {
    ...
    public Employee(long id, String name, String email, String jobTitle, String phone, String imgUrl, String employeesCode) {
        this.id = id;
        this.name = name;
        this.email = email;
